        ...
        if ($stasiunGmr && $stasiunBd && $keretaParahyangan) {
            Schedule::updateOrCreate(
                ...
                [
                    ...
                    'waktu_berangkat' => now()->addDays(5)->setTime(8, 0),
                    'waktu_tiba' => now()->addDays(5)->setTime(11, 0),
                    'harga' => 150000,
            ...
            Schedule::updateOrCreate(
                ...
                [
                    ...
                    'waktu_berangkat' => now()->addDays(6)->setTime(14, 0),
                    'waktu_tiba' => now()->addDays(6)->setTime(17, 0),
                    'harga' => 150000,
                    'harga_ekonomi' => 150000,
                    'harga_bisnis' => 200000,
                    'harga_eksekutif' => 250000,
        ...
        if ($stasiunGmr && $stasiunYk && $keretaTaksaka) {
            Schedule::updateOrCreate(
                ...
                [
                    ...
                    'waktu_berangkat' => now()->addDays(5)->setTime(9, 30),
                    'waktu_tiba' => now()->addDays(5)->setTime(16, 45),
                    'harga' => 350000,
        ...
        if ($stasiunGmr && $stasiunSgu && $keretaAnggrek) {
            Schedule::updateOrCreate(
                ...
                [
                    ...
                    'waktu_berangkat' => now()->addDays(7)->setTime(8, 20),
                    'waktu_tiba' => now()->addDays(7)->setTime(17, 30),
                    'harga' => 500000,
